...
function dataReportStatus(data) {
    ...
    for (let i = 0; i < data.Exclusive_Products.length; i++) {
        if(data.Exclusive_Products[i].Store_Name == "FahFahs" || data.Exclusive_Products[i].Store_Name == "Fahfahs"){
        ...
        if(data.Sticker[i].Store_Name == "FahFahs" || data.Sticker[i].Store_Name == "Fahfahs"){
        ...
        if(data.Postcard[i].Store_Name == "FahFahs" || data.Postcard[i].Store_Name == "Fahfahs"){
        ...
        if(data.Mobile_Gadget[i].Store_Name == "FahFahs" || data.Mobile_Gadget[i].Store_Name == "Fahfahs"){
        ...
        if(data.Memo_Pad[i].Store_Name == "FahFahs" || data.Memo_Pad[i].Store_Name == "Fahfahs"){
        ...
        if(data.Keychain[i].Store_Name == "FahFahs" || data.Keychain[i].Store_Name == "Fahfahs"){
        ...
        if(data.Masking_Tape[i].Store_Name == "FahFahs" || data.Masking_Tape[i].Store_Name == "Fahfahs"){
        ...
        if(data.Notebook[i].Store_Name == "FahFahs" || data.Notebook[i].Store_Name == "Fahfahs"){
        ...
        if(data.Accessory[i].Store_Name == "FahFahs" || data.Accessory[i].Store_Name == "Fahfahs"){
