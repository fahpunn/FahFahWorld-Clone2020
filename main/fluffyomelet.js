...
function dataReportStatus(data) {
    ...
    for (let i = 0; i < data.Exclusive_Products.length; i++) {
        if(data.Exclusive_Products[i].Store_Name == "FLUFFY OMELET"){
        ...
        if(data.Sticker[i].Store_Name == "FLUFFY OMELET"){
        ...
        if(data.Postcard[i].Store_Name == "FLUFFY OMELET"){
        ...
        if(data.Mobile_Gadget[i].Store_Name == "FLUFFY OMELET"){
        ...
        if(data.Memo_Pad[i].Store_Name == "FLUFFY OMELET"){
        ...
        if(data.Keychain[i].Store_Name == "FLUFFY OMELET"){
        ...
        if(data.Masking_Tape[i].Store_Name == "FLUFFY OMELET"){
        ...
        if(data.Notebook[i].Store_Name == "FLUFFY OMELET"){
        ...
        if(data.Accessory[i].Store_Name == "FLUFFY OMELET"){
