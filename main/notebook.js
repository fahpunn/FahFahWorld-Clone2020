...
function selector() {
    ...
    if(select == "default"){
        ...
        for (let i = 0; i < data.Notebook.length; i++) {
            for(let j = 0; j < data.Notebook.length; j++){
                if(data.Notebook[j].Popularity == i+1){
                    temp += '<div class="col-3"><a class="official" href="producttemplate.html"><img class="width-100" src="'+data.Notebook[j].Title_Image_Front+'"></a><p class="s-14 mt-3"><a class="product-a" href="producttemplate.html">'+data.Notebook[i].Title+'</a><br><span class="color-pink">★★★★★</span><br><b>'+data.Notebook[i].Price+'</b><br><br>Store : &nbsp;&nbsp;<img class="width-8" src="'+data.Notebook[i].Store_Image+'">&nbsp;<a href="'+data.Notebook[i].Store_Link+'" class="color-artist bold-artist">'+data.Notebook[i].Store_Name+'</a><p class="big-star">★★★★★</p><br></div>';
                    break;
                }
            }
        }
        ...
        for (let i = 0; i < data.Notebook.length; i++) {
            for(let j = 0; j < data.Notebook.length; j++){
                if(data.Notebook[j].Rating == i+1){
                    temp += '<div class="col-3"><a class="official" href="producttemplate.html"><img class="width-100" src="'+data.Notebook[j].Title_Image_Front+'"></a><p class="s-14 mt-3"><a class="product-a" href="producttemplate.html">'+data.Notebook[j].Title+'</a><br><span class="color-pink">★★★★★</span><br><b>'+data.Notebook[j].Price+'</b><br><br>Store : &nbsp;&nbsp;<img class="width-8" src="'+data.Notebook[j].Store_Image+'">&nbsp;<a href="'+data.Notebook[j].Store_Link+'" class="color-artist bold-artist">'+data.Notebook[j].Store_Name+'</a><p class="big-star">★★★★★</p><br></div>';
                    break;
                }
            }
        }
        ...
        for (let i = 0; i < data.Notebook.length; i++) {
            for(let j = 0; j < data.Notebook.length; j++){
                if(data.Notebook[j].Low_To_High == i+1){
                    temp += '<div class="col-3"><a class="official" href="producttemplate.html"><img class="width-100" src="'+data.Notebook[j].Title_Image_Front+'"></a><p class="s-14 mt-3"><a class="product-a" href="producttemplate.html">'+data.Notebook[j].Title+'</a><br><span class="color-pink">★★★★★</span><br><b>'+data.Notebook[j].Price+'</b><br><br>Store : &nbsp;&nbsp;<img class="width-8" src="'+data.Notebook[j].Store_Image+'">&nbsp;<a href="'+data.Notebook[j].Store_Link+'" class="color-artist bold-artist">'+data.Notebook[j].Store_Name+'</a><p class="big-star">★★★★★</p><br></div>';
                    break;
                }
            }
        ...
        for (let i = 0; i < data.Notebook.length; i++) {
            for(let j = 0; j < data.Notebook.length; j++){
                if(data.Notebook[j].High_To_Low == i+1){
                    temp += '<div class="col-3"><a class="official" href="producttemplate.html"><img class="width-100" src="'+data.Notebook[j].Title_Image_Front+'"></a><p class="s-14 mt-3"><a class="product-a" href="producttemplate.html">'+data.Notebook[j].Title+'</a><br><span class="color-pink">★★★★★</span><br><b>'+data.Notebook[j].Price+'</b><br><br>Store : &nbsp;&nbsp;<img class="width-8" src="'+data.Notebook[j].Store_Image+'">&nbsp;<a href="'+data.Notebook[j].Store_Link+'" class="color-artist bold-artist">'+data.Notebook[j].Store_Name+'</a><p class="big-star">★★★★★</p><br></div>';
                    break;
                }
            }
