...
function dataReportStatus(data) {
    ...
    for (let i = 0; i < data.Exclusive_Products.length; i++) {
        if(data.Exclusive_Products[i].Store_Name == "Ease Around"){
        ...
        if(data.Sticker[i].Store_Name == "Ease Around"){
        ...
        if(data.Postcard[i].Store_Name == "Ease Around"){
        ...
        if(data.Mobile_Gadget[i].Store_Name == "Ease Around"){
        ...
        if(data.Memo_Pad[i].Store_Name == "Ease Around"){
        ...
        if(data.Keychain[i].Store_Name == "Ease Around"){
        ...
        if(data.Masking_Tape[i].Store_Name == "Ease Around"){
        ...
        if(data.Notebook[i].Store_Name == "Ease Around"){
        ...
        if(data.Accessory[i].Store_Name == "Ease Around"){
